    ...
    <>
      <div className={classes.titleContainer}>
        <div className={classes.logoImage}>
          <Image
            src="https://i.ibb.co/0csqNyQ/logo-nobackground-5000.png"
            alt="Next Step Logo"
            width="300px"
            height="300px"
            quality="100"
        ...
        <div className={classes.containerLeft}>
          ...
          <Link href="https://www.npmjs.com/package/next-step-metrics">
            <a target="_blank">
      ...
      {/* <div className={classes.mainImage}>
        <h3>
          ...
          Vitals directly into your console as you develop -- providing
          actionable data in real-time to guide your site-performance decisions.
        </h3>
      </div> */}
